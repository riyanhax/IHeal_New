...
public final class CreateChargeRequest {
    ...
    public final static class Builder {
        ...
        /**
         * @param reference_order Merchant Order Reference Number
         */
        public Builder reference_order(String reference_order) {
            createChargeRequest.reference_order = reference_order;
            return this;
        }
